...
- (void)drawRect:(CGRect)rect {
	...
	if ([self.badgeText length]>0) {
		...
		//CGSize textSize = [self.badgeText sizeWithFont:textFont];
     	...
     	[self.badgeText drawAtPoint:CGPointMake((rect.size.width/2-textSize.width/2), (rect.size.height/2-textSize.height/2)) withAttributes:@{NSFontAttributeName:textFont, NSForegroundColorAttributeName: badgeTextColor}];
	}
