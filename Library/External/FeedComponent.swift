...
public protocol FeedComponentTarget: class {
  ...
  */
    func loadInRange(type: SceneType, range: Range<Int>, completionBlock: ([ContentType]?) -> Void)
}
...
1. Implement the `FeedComponentTarget` protocol
...
*/
public class FeedComponent <T: Equatable, S: FeedComponentTarget where S.ContentType == T> : Refreshable {
